<template>
  <span v-bind="$attrs"
        ...
        :aria-label="title"
        class="material-design-icon clock-star-four-points-outline-icon"
        role="img"
...
<script>
export default {
  name: "ClockStarFourPointsOutlineIcon",
  emits: ['click'],
  props: {
    title: {
      type: String,
