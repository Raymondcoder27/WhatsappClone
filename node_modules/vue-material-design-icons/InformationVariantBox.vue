<template>
  <span v-bind="$attrs"
        ...
        :aria-label="title"
        class="material-design-icon information-variant-box-icon"
        role="img"
...
<script>
export default {
  name: "InformationVariantBoxIcon",
  emits: ['click'],
  props: {
    title: {
      type: String,
