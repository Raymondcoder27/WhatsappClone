<template>
  <span v-bind="$attrs"
        ...
        :aria-label="title"
        class="material-design-icon weather-hurricane-outline-icon"
        role="img"
...
<script>
export default {
  name: "WeatherHurricaneOutlineIcon",
  emits: ['click'],
  props: {
    title: {
      type: String,
