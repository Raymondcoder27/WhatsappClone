<template>
  <span v-bind="$attrs"
        ...
        :aria-label="title"
        class="material-design-icon invoice-text-clock-outline-icon"
        role="img"
...
<script>
export default {
  name: "InvoiceTextClockOutlineIcon",
  emits: ['click'],
  props: {
    title: {
      type: String,
