<template>
  <span v-bind="$attrs"
        ...
        :aria-label="title"
        class="material-design-icon account-file-text-outline-icon"
        role="img"
...
<script>
export default {
  name: "AccountFileTextOutlineIcon",
  emits: ['click'],
  props: {
    title: {
      type: String,
