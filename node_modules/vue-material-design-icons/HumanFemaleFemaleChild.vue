<template>
  <span v-bind="$attrs"
        ...
        :aria-label="title"
        class="material-design-icon human-female-female-child-icon"
        role="img"
...
<script>
export default {
  name: "HumanFemaleFemaleChildIcon",
  emits: ['click'],
  props: {
    title: {
      type: String,
