<template>
  <span v-bind="$attrs"
        ...
        :aria-label="title"
        class="material-design-icon account-box-minus-outline-icon"
        role="img"
...
<script>
export default {
  name: "AccountBoxMinusOutlineIcon",
  emits: ['click'],
  props: {
    title: {
      type: String,
