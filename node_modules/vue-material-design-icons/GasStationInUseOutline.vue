<template>
  <span v-bind="$attrs"
        ...
        :aria-label="title"
        class="material-design-icon gas-station-in-use-outline-icon"
        role="img"
...
<script>
export default {
  name: "GasStationInUseOutlineIcon",
  emits: ['click'],
  props: {
    title: {
      type: String,
