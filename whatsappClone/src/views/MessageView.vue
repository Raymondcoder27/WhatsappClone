      ...
      <div class="border-left border-green-500 w-full">
        ...
        >
          <div class="flex items-center">
            ...
            />
            <div class="font-semibold ml-1 text-gray-900">Frank</div>
          </div>
        ...
        <div class="px-20 text-sm">
          <div class="flex w-[calc(100%-50px)]">
            <div class="inline-block bg-white rounded-md p-2 my-1">
              ...
              nihil necessitatibus quisquam eos expedita assumenda, quod
              repellendus ullam voluptate, laborum velit! Asperiores tempora
              sunt molestiae aut error iure enim in.
            </div>
          </div>
